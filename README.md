...
### Firebase authorized domains (required for Google Sign-In on your live site)
...
2. Click **Add domain** and add:
   - `hopepath.net` (your custom domain — **localhost is not enough for production**)
   - Your Netlify URL if you still use it, e.g. `your-site-name.netlify.app`

Without this step, Google sign-in works on `localhost` but **fails on the live site**.
